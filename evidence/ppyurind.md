...
| Media OCR/STT backend scope | 인증된 미디어 업로드·OCR·realtime STT token flow를 Backend에 추가한 별도 기여. 현재 Case Study 핵심 축에서는 보조 근거로만 취급 | [PR #14](https://github.com/AIStreetFighter/ppyurind-backend/pull/14) · [PR #16](https://github.com/AIStreetFighter/ppyurind-backend/pull/16) | Direct PR metadata; not used for LLM quality claims |
