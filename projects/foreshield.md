...
### 1. Agent Foundation & Context Interpretation
...
그 위에 자연어 요청을 바로 Tool 호출로 넘기지 않고 Context Interpretation을 AgentPlan으로 변환하도록 구현했습니다. 지역·재난·lead 등 필수 정보가 불명확하면 임의 fallback 대신 clarification 또는 오류 상태로 종료하도록 했습니다. [PR #36](https://github.com/ForeShield/backend/pull/36) · [PR #187](https://github.com/ForeShield/backend/pull/187) · [PR #194](https://github.com/ForeShield/backend/pull/194)

### 2. Intent-based Tool Routing & Execution Policy

불완전한 요청이 잘못된 Tool 실행으로 이어질 가능성을 줄이기 위해 intent별 Tool 선택, 필수 입력 확인, clarification과 병렬화 후보를 분리한 Router 정책을 구현했습니다.

또한 Live/Training 모드별 allowlist, 승인 전 deferred 상태, UI Action의 실행 대상 검증을 Backend 정책으로 두었습니다. 따라서 사용자의 확인이 필요한 동작이나 실제 화면 상태와 맞지 않는 동작은 실행하지 않고 종료할 수 있습니다. [PR #221](https://github.com/ForeShield/backend/pull/221) · [PR #224](https://github.com/ForeShield/backend/pull/224) · [PR #252](https://github.com/ForeShield/backend/pull/252)

### 3. Azure OpenAI / RAG Integration & Structured Output
...
RAG와 Context 안의 문장은 시스템 지시가 아닌 데이터로 처리하도록 Prompt 경계를 보강했고, Structured Output 위반·허용되지 않은 Action·실행 대상 불일치는 fail-closed로 처리했습니다. Token diagnostics에는 원문 대신 finish reason, response length, 제한된 usage 정보만 남기도록 했습니다. [PR #230](https://github.com/ForeShield/backend/pull/230) · [PR #241](https://github.com/ForeShield/backend/pull/241) · [PR #245](https://github.com/ForeShield/backend/pull/245)
...
4. [Issue #18](https://github.com/ForeShield/backend/issues/18): Mock Provider 기반 AgentEngine streaming
5. [Issue #19](https://github.com/ForeShield/backend/issues/19): AgentEngine 계약·정책 테스트
...
- [PR #36](https://github.com/ForeShield/backend/pull/36): 로컬 pytest 34 passed, 17 skipped, Ruff와 GitHub Actions 단계 통과
- [PR #221](https://github.com/ForeShield/backend/pull/221): Intent-based Tool Router 집중 테스트 21 passed
...
- [PR #36 — Contract-based Agent Engine foundation](https://github.com/ForeShield/backend/pull/36)
- [PR #194 — Context Interpretation](https://github.com/ForeShield/backend/pull/194)
- [PR #221 — Intent-based Tool Router](https://github.com/ForeShield/backend/pull/221)
- [PR #230 — Prompt Injection defense](https://github.com/ForeShield/backend/pull/230)
- [PR #234 — Structured Answer](https://github.com/ForeShield/backend/pull/234)
- [PR #245 — Orchestration and provenance](https://github.com/ForeShield/backend/pull/245)
